...
This is a general style guide that shall govern over all **TitleWidget** project. The aim is
...
- You must always use relative imports for imports within the `title_widget` library
